...
execute if score @p[distance=0..6,scores={chk.style=0..}] chk.style = Chair_Throne chk.style at @s positioned ~ ~ ~ as @e[distance=0..0.5,limit=1,tag=chk.chair.interaction] run data modify entity @s height set value 1.8
