...
execute unless score @s chk.carpet_color matches 0.. at @s positioned ~ ~0.3 ~ as @e[tag=chk.chair.model,distance=0..0.4] if entity @s[tag=chk.facing.north] at @s run summon item_display ~ ~ ~ {Rotation:[0f,  0f],item:{id:"jungle_trapdoor",Count:1,tag:{CustomModelData:9000000}},item_display:head,view_range:0.65f,width:1,height:1,Tags:["chk.block","smithed.block","chk.chair","chk.chair.item","chk.chair.cushion","tac.V5.0"]}
execute unless score @s chk.carpet_color matches 0.. at @s positioned ~ ~0.3 ~ as @e[tag=chk.chair.model,distance=0..0.4] if entity @s[tag=chk.facing.east ] at @s run summon item_display ~ ~ ~ {Rotation:[90f, 0f],item:{id:"jungle_trapdoor",Count:1,tag:{CustomModelData:9000000}},item_display:head,view_range:0.65f,width:1,height:1,Tags:["chk.block","smithed.block","chk.chair","chk.chair.item","chk.chair.cushion","tac.V5.0"]}
execute unless score @s chk.carpet_color matches 0.. at @s positioned ~ ~0.3 ~ as @e[tag=chk.chair.model,distance=0..0.4] if entity @s[tag=chk.facing.south] at @s run summon item_display ~ ~ ~ {Rotation:[180f,0f],item:{id:"jungle_trapdoor",Count:1,tag:{CustomModelData:9000000}},item_display:head,view_range:0.65f,width:1,height:1,Tags:["chk.block","smithed.block","chk.chair","chk.chair.item","chk.chair.cushion","tac.V5.0"]}
execute unless score @s chk.carpet_color matches 0.. at @s positioned ~ ~0.3 ~ as @e[tag=chk.chair.model,distance=0..0.4] if entity @s[tag=chk.facing.west ] at @s run summon item_display ~ ~ ~ {Rotation:[270f,0f],item:{id:"jungle_trapdoor",Count:1,tag:{CustomModelData:9000000}},item_display:head,view_range:0.65f,width:1,height:1,Tags:["chk.block","smithed.block","chk.chair","chk.chair.item","chk.chair.cushion","tac.V5.0"]}
