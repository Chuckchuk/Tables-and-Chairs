#Set the Table Top
data modify entity @s HandItems[0] set value {tag:{CustomModelData:9004200},id:"minecraft:jungle_trapdoor",Count:1b}
...
scoreboard players set @s chk.start_model 9004200
