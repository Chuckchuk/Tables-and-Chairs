#Set the Table Top
data modify entity @s HandItems[0] set value {tag:{CustomModelData:9002200},id:"minecraft:jungle_trapdoor",Count:1b}
...
# Basic1
execute if score @p[distance=0..6,scores={chk.style=0..}] chk.style = Table.style.basic.1 chk.style run data modify entity @s ArmorItems[3] set value {tag:{CustomModelData:9002201},id:"minecraft:jungle_trapdoor",Count:1b}
...
# Basic2
execute if score @p[distance=0..6,scores={chk.style=0..}] chk.style = Table.style.basic.2 chk.style run data modify entity @s ArmorItems[3] set value {tag:{CustomModelData:9002211},id:"minecraft:jungle_trapdoor",Count:1b}
...
# Carved1
execute if score @p[distance=0..6,scores={chk.style=0..}] chk.style = Table.style.carved.1 chk.style run data modify entity @s ArmorItems[3] set value {tag:{CustomModelData:9002221},id:"minecraft:jungle_trapdoor",Count:1b}
...
# Carved2
execute if score @p[distance=0..6,scores={chk.style=0..}] chk.style = Table.style.carved.2 chk.style run data modify entity @s ArmorItems[3] set value {tag:{CustomModelData:9002231},id:"minecraft:jungle_trapdoor",Count:1b}
...
tag @s add chk.table.birch
scoreboard players set @s chk.cycle 1
scoreboard players set @s chk.start_model 9002200
