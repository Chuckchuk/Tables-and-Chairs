...
execute as @s positioned ~0 ~0 ~0 align xyz positioned ~0.5 ~0.5 ~0.5 if block ~ ~ ~ jungle_trapdoor unless entity @e[type=item_display,distance=..0.5,tag=chk.block] run function tac:table/place/found

execute as @s[scores={chk.distance=1..}] anchored feet positioned ^ ^ ^0.1 run function tac:table/place/find
...
execute as @s[scores={chk.distance=0}] run function tac:table/place/init

execute as @s[scores={chk.distance=0}] run function tac:table/place/revoke