...
# Special Case the Right Side on Cycle 4
execute if score @s chk.cycle matches 4 as @s[tag=chk.facing.north,tag=chk.direction.r] run data modify entity @s Rotation[0] set value 90f
execute if score @s chk.cycle matches 4 as @s[tag=chk.facing.east,tag=chk.direction.r] run data modify entity @s Rotation[0] set value 180f
execute if score @s chk.cycle matches 4 as @s[tag=chk.facing.south,tag=chk.direction.r] run data modify entity @s Rotation[0] set value 270f
execute if score @s chk.cycle matches 4 as @s[tag=chk.facing.west,tag=chk.direction.r] run data modify entity @s Rotation[0] set value 0f
