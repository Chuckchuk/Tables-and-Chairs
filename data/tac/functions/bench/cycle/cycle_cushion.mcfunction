...
# Set the Cycle
execute if score @e[limit=1,distance=0..0.4,tag=chk.bench.model] chk.cycle matches 0 run scoreboard players add Carpet_Style chk.temp 000
execute if score @e[limit=1,distance=0..0.4,tag=chk.bench.model] chk.cycle matches 1 run scoreboard players add Carpet_Style chk.temp 100
execute if score @e[limit=1,distance=0..0.4,tag=chk.bench.model] chk.cycle matches 2 run scoreboard players add Carpet_Style chk.temp 200
execute if score @e[limit=1,distance=0..0.4,tag=chk.bench.model] chk.cycle matches 3 run scoreboard players add Carpet_Style chk.temp 300
execute if score @e[limit=1,distance=0..0.4,tag=chk.bench.model] chk.cycle matches 4 run scoreboard players add Carpet_Style chk.temp 400
execute if score @e[limit=1,distance=0..0.4,tag=chk.bench.model] chk.cycle matches 5 run scoreboard players add Carpet_Style chk.temp 500
