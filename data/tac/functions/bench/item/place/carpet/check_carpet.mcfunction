...
# Rotate Cushion to the Bench
execute at @s positioned ~ ~0.3 ~ as @e[tag=chk.bench.model,distance=0..0.4] run data modify entity @e[limit=1,sort=nearest,tag=chk.bench.cushion,distance=0..0.4] Rotation set from entity @s Rotation
