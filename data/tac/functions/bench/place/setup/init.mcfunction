...
execute as @s[advancements={tac:place/bench/type/mangrove=true}] run scoreboard players set @s chk.type 30
execute as @s[advancements={tac:place/bench/type/cherry=true}] run scoreboard players set @s chk.type 35
execute as @s[advancements={tac:place/bench/type/bamboo=true}] run scoreboard players set @s chk.type 40
execute as @s[advancements={tac:place/bench/type/crimson=true}] run scoreboard players set @s chk.type 45
execute as @s[advancements={tac:place/bench/type/warped=true}] run scoreboard players set @s chk.type 50
