...
summon interaction ~ ~0.25 ~ {CustomName:"\"Bench Interaction\"",Rotation:[0f,90f,0f],height:1,width:0.975,Tags:["smithed.block","chk.interaction","chk.punch_break","chk.bench","chk.bench.interaction","tac.V5.0"]}
