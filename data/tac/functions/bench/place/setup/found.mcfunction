...
summon interaction ~ ~ ~ {CustomName:"\"Bench Interaction\"",Rotation:[0f,90f,0f],height:1.2,width:0.975,Tags:["smithed.block","chk.interaction","chk.bench","chk.bench.interaction","tac.V5.0"]}
