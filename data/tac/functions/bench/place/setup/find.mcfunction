...
execute as @s positioned ~0 ~0 ~0 align xyz positioned ~0.5 ~0.5 ~0.5 if block ~ ~ ~ jungle_trapdoor unless entity @e[distance=..0.5,tag=chk.block] positioned ~ ~-0.5 ~ run function tac:bench/place/setup/found
#Return if placed in the same 
execute as @s positioned ~0 ~0 ~0 align xyz positioned ~0.5 ~0.5 ~0.5 if block ~ ~ ~ jungle_trapdoor if entity @e[distance=..0.5,tag=chk.block] run function tac:bench/place/setup/found_failure


execute as @s[scores={chk.distance=1..}] anchored feet positioned ^ ^ ^0.1 run function tac:bench/place/setup/find
...
execute as @s[scores={chk.distance=0}] run function tac:bench/place/setup/init

#Revoke again
execute as @s[scores={chk.distance=0}] run function tac:bench/place/setup/revoke
