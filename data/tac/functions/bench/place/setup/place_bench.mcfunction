...
execute as @a[tag=chk.delay] at @s if score @s chk.type = Bench.darkOak chk.type as @e[limit=1,sort=nearest,tag=chk.bench,tag=chk.not_done] run function tac:bench/place/type/dark_oak
