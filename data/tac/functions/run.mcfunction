...
# Run Chairs
## V5.0
execute at @a as @e[distance=0..6.5,tag=chk.chair.interaction] run function tac:chair/run_chair

## V5.0 and Earlier (No Longer Needed)
...
#Run Sawmill
execute at @a as @e[distance=0..6.5,tag=tac.sawmill] at @s run function tac:sawmill/run_sawmill
# execute at @a as @e[distance=0..6.5,tag=tac.sawmill] run function sawmill:core/tick
