...
execute as @s[y_rotation=135..225] positioned ~ ~0.5 ~ run summon item_display ~ ~ ~ {item:{id:"minecraft:jungle_trapdoor",Count:1b,tag:{CustomModelData:9001501}},item_display:head,Tags:["chk.block","smithed.block","tac.sawmill","tac.V5.0"],Rotation:[270f],view_range:0.8f,width:1,height:1}
execute as @s[y_rotation=225..315] positioned ~ ~0.5 ~ run summon item_display ~ ~ ~ {item:{id:"minecraft:jungle_trapdoor",Count:1b,tag:{CustomModelData:9001501}},item_display:head,Tags:["chk.block","smithed.block","tac.sawmill","tac.V5.0"],Rotation:[0f],view_range:0.8f,width:1,height:1}
execute as @s[y_rotation=-45..45] positioned ~ ~0.5 ~ run summon item_display ~ ~ ~ {item:{id:"minecraft:jungle_trapdoor",Count:1b,tag:{CustomModelData:9001501}},item_display:head,Tags:["chk.block","smithed.block","tac.sawmill","tac.V5.0"],Rotation:[90f],view_range:0.8f,width:1,height:1}
execute as @s[y_rotation=45..135] positioned ~ ~0.5 ~ run summon item_display ~ ~ ~ {item:{id:"minecraft:jungle_trapdoor",Count:1b,tag:{CustomModelData:9001501}},item_display:head,Tags:["chk.block","smithed.block","tac.sawmill","tac.V5.0"],Rotation:[180f],view_range:0.8f,width:1,height:1}
