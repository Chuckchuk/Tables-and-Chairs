#> sawmill:block/sawmill/gui/recipes/main
...
execute if data storage sawmill:temp input.id if data storage sawmill:temp recipes[0] run function sawmill:block/sawmill/gui/recipes/loop
