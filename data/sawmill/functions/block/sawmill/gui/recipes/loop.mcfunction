#> sawmill:block/sawmill/gui/recipes/loop
...
execute if score #different tac.temp matches 0 if score #input_count tac.temp >= #recipe_cost tac.temp run function sawmill:block/sawmill/gui/recipes/add


# Loop
data remove storage sawmill:temp recipes[-1]
execute if data storage sawmill:temp recipes[-1] run function sawmill:block/sawmill/gui/recipes/loop