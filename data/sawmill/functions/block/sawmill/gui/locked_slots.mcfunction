#> sawmill:block/sawmill/gui/locked_slots
...
execute if entity @s[tag=!tac.has_input] if data storage sawmill:temp insertedItems[{Slot:0b}] run function sawmill:block/sawmill/gui/insert_input

## Drop items if there's at least one
execute if data storage sawmill:temp insertedItems[0] at @a[sort=nearest,limit=1,distance=..8] run function sawmill:block/sawmill/gui/drop_items
...
execute if data storage sawmill:temp savedData.recipes[0] run function sawmill:block/sawmill/gui/check_craftings
